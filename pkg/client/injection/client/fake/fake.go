...
import (
	...
	fake "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
