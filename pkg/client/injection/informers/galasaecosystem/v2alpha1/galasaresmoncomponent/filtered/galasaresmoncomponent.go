...
func Get(ctx context.Context, selector string) v2alpha1.GalasaResmonComponentInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/informers/externalversions/galasaecosystem/v2alpha1.GalasaResmonComponentInformer with selector %s from context.", selector)
	}
