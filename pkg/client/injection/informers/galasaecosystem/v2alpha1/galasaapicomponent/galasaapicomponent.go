...
func Get(ctx context.Context) v2alpha1.GalasaApiComponentInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/informers/externalversions/galasaecosystem/v2alpha1.GalasaApiComponentInformer from context.")
	}
