...
import (
	...
	galasacpscomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasacpscomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasacpscomponent-controller"
	defaultFinalizerName       = "galasacpscomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasacpscomponentInformer := galasacpscomponent.Get(ctx)

	lister := galasacpscomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaCpsComponent"),
	)
