...
import (
	...
	versionedscheme "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/clientset/versioned/scheme"
	client "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/client"
	galasaenginecontrollercomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasaenginecontrollercomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasaenginecontrollercomponent-controller"
	defaultFinalizerName       = "galasaenginecontrollercomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasaenginecontrollercomponentInformer := galasaenginecontrollercomponent.Get(ctx)

	lister := galasaenginecontrollercomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaEngineControllerComponent"),
	)
