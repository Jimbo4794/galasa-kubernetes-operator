...
const (
	defaultControllerAgentName = "galasaecosystem-controller"
	defaultFinalizerName       = "galasaecosystems.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasaecosystemInformer := galasaecosystem.Get(ctx)

	lister := galasaecosystemInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaEcosystem"),
	)
