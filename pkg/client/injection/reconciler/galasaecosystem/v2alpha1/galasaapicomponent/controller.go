...
import (
	...
	galasaapicomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasaapicomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasaapicomponent-controller"
	defaultFinalizerName       = "galasaapicomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasaapicomponentInformer := galasaapicomponent.Get(ctx)

	lister := galasaapicomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaApiComponent"),
	)
