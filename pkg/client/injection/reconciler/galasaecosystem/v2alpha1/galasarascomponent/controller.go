...
import (
	...
	galasarascomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasarascomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasarascomponent-controller"
	defaultFinalizerName       = "galasarascomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasarascomponentInformer := galasarascomponent.Get(ctx)

	lister := galasarascomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaRasComponent"),
	)
