...
import (
	...
	galasatoolboxcomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasatoolboxcomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasatoolboxcomponent-controller"
	defaultFinalizerName       = "galasatoolboxcomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasatoolboxcomponentInformer := galasatoolboxcomponent.Get(ctx)

	lister := galasatoolboxcomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaToolboxComponent"),
	)
