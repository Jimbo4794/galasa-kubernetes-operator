...
import (
	...
	galasametricscomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasametricscomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasametricscomponent-controller"
	defaultFinalizerName       = "galasametricscomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasametricscomponentInformer := galasametricscomponent.Get(ctx)

	lister := galasametricscomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaMetricsComponent"),
	)
