...
import (
	...
	galasaresmoncomponent "github.com/Jimbo4794/galasa-kubernetes-operator/pkg/client/injection/informers/galasaecosystem/v2alpha1/galasaresmoncomponent"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "galasaresmoncomponent-controller"
	defaultFinalizerName       = "galasaresmoncomponents.galasa.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	galasaresmoncomponentInformer := galasaresmoncomponent.Get(ctx)

	lister := galasaresmoncomponentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "galasa.dev.GalasaResmonComponent"),
	)
